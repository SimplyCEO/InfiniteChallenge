...
execute unlesss entity @e[type=minecraft:item_frame,tag=IC_spawn] if entity @s[nbt={Dimension:0}] unless score @s pos_y matches 1..10 run tag @s remove IC_player_visit
